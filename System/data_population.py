...
query="""CREATE TABLE `Patients` (
	...
	`Registeration_Date` varchar(15) NOT NULL,
	`Primary_Doctor` varchar(50) DEFAULT NULL,
	`Corporate_Coverage` varchar(50) DEFAULT NULL,
	`Last_Visit` varchar(15) DEFAULT NULL,
	`Last_Diagnosis` varchar(500) DEFAULT NULL,
	`Number_of_visits` varchar(50) DEFAULT 0,
	...
	`Blood_Oxygen` varchar(50) DEFAULT NULL,
	`Body_Fat` varchar(50) DEFAULT NULL,
	`Respiratory_Rate` varchar(50) DEFAULT NULL,
	`Cholestrol_Level` varchar(50) DEFAULT NULL,
	`Sleep_Duration` varchar(50) DEFAULT NULL,
	`Haemoglobin_Level` varchar(50) DEFAULT NULL,
	`Vitamin_Deficiency` varchar(100) DEFAULT NULL,

	`Cancer_Type` varchar(100) DEFAULT NULL,
	`Cancer_Stage` varchar(10) DEFAULT NULL,
	`Heart_Disease` varchar(50) DEFAULT NULL,
	`Diabetic` varchar(50) DEFAULT 0,

	`Surgeries` varchar(100) DEFAULT NULL,
	`Organ_Replacement` varchar(100) DEFAULT NULL,
	`Fractures` varchar(100) DEFAULT NULL,

	`Alcoholic` varchar(50) DEFAULT 0,
	`Smoker` varchar(50) DEFAULT 0,
	`Drug_Abuse` varchar(50) DEFAULT 0,
	`Rehab` varchar(50) DEFAULT 0,
